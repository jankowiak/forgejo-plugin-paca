...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-RDnAgPtW.js', import.meta.url).href),import:true,requiredVersion:'^19.0.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-Co4fktlm.js', import.meta.url).href),import:true,requiredVersion:'^19.0.0'},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-CuDg_m18.js', import.meta.url).href),import:true,requiredVersion:'^5.0.0'}};
